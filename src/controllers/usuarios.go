...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if seguidorID == usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível alterar a senha de outro usuário"))
		return
	}
	...
	if erro := seguranca.ValidatePassword(senhaSalvaNoBanco, senha.Atual); erro != nil {
